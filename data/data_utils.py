...
def sort_all(batch, lens):
    ...
    input:
        batch=[
                [word_id_list_1, word_id_list_2, word_id_list_3],
                [char_id_list_1, char_id_list_2, char_id_list_3],
                [upos_id_list_1, upos_id_list_2, upos_id_list_3],
                [pretrain_list_1, pretrain_list_2, pretrain_list_3],
                [arc_list_1, arc_list_2, arc_list_3]
                ]
        lens=[1,3,2]

    output[0]:
            [
                [word_id_list_2, word_id_list_3, word_id_list_1],
                [char_id_list_2, char_id_list_3, char_id_list_1],
                [upos_id_list_2, upos_id_list_3, upos_id_list_1],
                [pretrain_list_2, pretrain_list_3, pretrain_list_1],
                [arc_list_2, arc_list_3, arc_list_1]
            ]
    output[1]:
            [1,2,0]
    """
